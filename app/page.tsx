...
// 프로젝트 데이터 관리 (이곳에 객체를 추가하면 무한 확장 가능)
const PROJECTS = [
  {
    id: "discipline",
              ...
              <div className="min-h-[101%] flex flex-col">
                <div className="flex w-full justify-between items-center px-8 py-10 md:px-20">
                  ...
                  <button
                    ...
                    className="hover:rotate-90 transition-transform text-zinc-400 hover:text-black"
                  >
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-8 py-20 md:px-20">
                  <div className="max-w-4xl w-full space-y-24">
                    <h2 className="text-4xl md:text-7xl font-bold tracking-tighter text-zinc-900 text-center">
                      {project.title}
                    </h2>
                    <div className="border-t border-zinc-200 pt-16">
                      <p className="text-lg text-zinc-600 leading-relaxed text-center max-w-2xl mx-auto">
                        {project.longDesc}
                      </p>
                      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-16 text-left">
                        <div>
                          ...
                          <h3 className="text-xs font-bold tracking-[0.3em] uppercase mt-4 mb-4 text-zinc-900">
                            Core Features
                          </h3>
                          ...
                          {project.link && (
                            <div className="mt-12 pt-8 border-t border-zinc-100">
                              <a 
                                ...
                                className="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] uppercase text-black hover:text-zinc-400 transition-colors"
                              >
                  ...
                  <div className="space-y-32">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-left border-t border-zinc-200 pt-16">
                      <div>
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">
                          Understand the 'WHY' before the 'what'. I build products rooted in deep
                          psychological understanding, not just trends.
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">
                          I design for clarity, not 'flashy noise'. Refined interaction over
                          decorative features. Remove the excess. Expose the value.
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">
                          I build tools that return time to the individual. By visualizing the
                          unseen, I make focus concrete.
                        </p>
                      </div>
                    </div>

                    <div className="space-y-12">
                      <div className="space-y-4 text-zinc-700 font-medium tracking-tight text-xl md:text-2xl">
                        <p>I question the why.</p>
                        <p>I remove the unnecessary.</p>
                        <p>I make focus visible.</p>
                      </div>
                      <div className="pt-12 border-t border-zinc-200 max-w-md mx-auto">
                        <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-zinc-400 leading-relaxed">
                          I build for those who choose control over distraction.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <>
            ...
            >
              <div>
                <button
                  onClick={() => setIsContactOpen(false)}
                  className="mb-20 hover:rotate-90 transition-transform"
                >
                  <X size={24} strokeWidth={1.5} />
                </button>
                <div className="space-y-12">
                  <div className="group">
                    <p className="text-[10px] font-bold tracking-[0.3em] text-zinc-400 uppercase mb-4">
                      Email
                    </p>
                    <div className="flex items-baseline gap-4">
                      <button
                        onClick={copyEmail}
                        className="text-xl font-medium tracking-tight hover:text-zinc-500 transition-colors text-left break-all"
                      >
                  ...
                  <div className="group">
                    ...
                    <div className="flex items-baseline gap-4">
                      <a
                        href="https://www.instagram.com/nneoum/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block text-xl font-medium tracking-tight hover:text-zinc-500 transition-colors"
                      >
                        Instagram
                      </a>
                      <span className="text-[10px] font-mono tracking-widest text-zinc-300 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                  ...
                  <div className="group">
                    ...
                    <div className="flex items-baseline gap-4">
                      <a
                        href="https://github.com/shfoddlrha-a11y"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block text-xl font-medium tracking-tight hover:text-zinc-500 transition-colors"
                      >
        ...
        <div className="relative z-10 w-full bg-zinc-50/50">
          ...
          <div className="relative z-10">
            <motion.section
              {...scrollReveal}
              id="products"
              className="border-t border-zinc-200 px-8 py-32 md:px-20"
            >
              ...
              <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-2">
                {PROJECTS.map((project) => (
                  <div
                    ...
                    className="group relative overflow-hidden rounded-xl border border-zinc-200 bg-white/95 p-10 shadow-md backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:border-black hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] cursor-pointer"
                  >
                    <h3 className="text-2xl font-bold tracking-tight">{project.title}</h3>
                    <p className="mt-4 text-sm leading-relaxed text-zinc-500">
                      {project.shortDesc.split("\n").map((line, i) => (
                        <span key={i}>
                          {line}
                          <br />
                        </span>
                    ...
                    <div className="mt-10 flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 font-mono">
                      <span>[ {project.status} ]</span> <span>[ {project.tech} ]</span>
                    </div>
                  </div>
                ))}
            ...
            >
              ...
              <div className="mt-16 relative border-l border-zinc-200 ml-2 space-y-12">
                <div className="relative pl-8">
                  ...
                  <p className="mt-2 text-sm font-medium text-zinc-500">Initial Ideation</p>
                </div>
                <div className="relative pl-8">
                  <div className="absolute -left-[5px] top-1.5 h-2 w-2 rounded-full bg-black shadow-[0_0_10px_rgba(0,0,0,0.1)]" />
                  <p className="text-[10px] font-bold tracking-[0.2em] text-black">
                    2026.02
                  </p>
                  <p className="mt-2 text-sm font-medium text-zinc-900">Discipline Premium</p>
                </div>
                <div className="relative pl-8">
                  ...
                  <p className="mt-2 text-sm font-medium text-zinc-400">Secret Project</p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="max-w-3xl rounded-2xl bg-white/60 p-10 shadow-sm backdrop-blur-sm border border-white/40">
                ...
                <p className="mt-8 text-lg leading-relaxed text-zinc-600">
                  'Shoot to the moon, even miss will be the stars.'
                </p>
                <button
                ...
                >
                  Read <ArrowRight size={12} className="inline ml-1 mb-0.5" />
                </button>
              </div>
            </motion.section>
            ...
            <footer className="border-t border-zinc-200 px-8 py-20 md:px-20 bg-white/80 backdrop-blur-sm">
              <div className="flex flex-col items-start justify-between gap-10 md:flex-row md:items-center">
                <span className="text-xs tracking-[0.1em] font-medium text-zinc-500">
                  © 2026 NNEOUM. All rights reserved.
                </span>
                <div className="flex gap-6 text-zinc-400">
                  <a
                    href="https://github.com/nneoum"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-black transition-colors"
                  >
